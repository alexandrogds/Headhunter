...
"""Verificar se tem novas vagas em trabalhabrasil.com.br
...
parser = argparse.ArgumentParser(description='Check for new job postings on trabalhabrasil.com.br')
...
url = 'https://www.trabalhabrasil.com.br/vagas-empregos/ti?fh=home-office&fpcd=pcd&ordenacao=2'
...
with open('trabalhabrasil.html', 'w', encoding='utf-8') as file:
...
articles = soup.find_all('a', {'class': 'jobCard homeoffice'})
job_links = [article['href'] for article in articles]

# Load existing data from JSON file if it exists
try:
    with open('trabalhabrasil.json', 'r') as file:
...
with open('trabalhabrasil.json', 'w') as file:
